...
GPT 系列很划算, GPT5.4 是人民币¥0.5(进)3(出)/一百万Token,  GPT5.6是人民币¥1(进)6(出)/一百万Token (非常推荐. 我自己的主力)
...
### [柏拉图AI](https://www.hvoy.ai/relaySite?name=%E6%9F%8F%E6%8B%89%E5%9B%BEAI&source=git)
...
价格方面, 质量比较好的Claude Opus4.7是人民币¥10(进)50(出)/一百万Token, Sonnet4.6是人民币¥6(进)30(出)/一百万Token. 
...
GPT 5.5是人民币¥4(进)24(出)/一百万Token. 价格是不便宜.
...
也有Codex接口, 目前是GPT5.5 是人民币 2(进)12(出)/一百万Token, 
...
价格方面, 逆向的Opus4.7是人民币¥3/15一百万token(质量够用), MAX号池是人民币¥7.5/37.5 一百万token(质量较好)
GPT5.5是人民币¥2/16 一百万token.

提供包月的套餐, 最便宜的是249人民币每月, 每周额度150元, 每个月600元, 可以用于claude模型.
...
但是缺点是, 没有试用额度, 每次最少买35人民币. 网站看起来有点绕.
...
**不过需要注意的是, 这个站的缓存价格比较贵,是0.5倍. (一般网站都在0.1-0.2倍之间). 写代码大量使用缓存, 所以这个站其实一点也不便宜**

GPT5.4刚上, 价格是人民币¥0.5(进)3(出)/一百万Token.
