...
----
- [JiuRelay](https://jiurelay.com/) - 免费 GPT/Claude/GLM 中转，无需注册，设备验证即领 1 小时 Key，兼容 OpenAI/Anthropic 协议
...
GPT 系列还可以, GPT 5.6 Sol是人民币¥2(进)12(出)/一百万Token
...
### [NekoCode](https://www.hvoy.ai/sites/nekocodeai)
2026年新开的一个站点, 提供Claude, GPT 两种类型的API.
界面风格也是淡淡的, 甚得我心.

接口异常稳定, claude 就有 max号池 和kiro 两个选择. 都挺稳定的, max 质量很好,kiro 比较实惠.

价格比较合理, max渠道的 Fable-5 价格是 ¥18(进)90(出)/一百万Token, 质量对得起这个价格. 
...
### [Claude API](https://www.hvoy.ai/sites/claudeapicom)

Claude API 也是一个26年4月份新成立的站. 我自己试了试质量还可以. 只支持Claude 和GPT, 不支持Gemini. (谷歌慢慢在AI竞争中落伍了啊)

Opus 4.8 推荐的渠道是叫 "Claude官方"的渠道, 价格是人民币¥10(进)50(出)/一百万Token. 现在质量好的, 大概都是10块钱左右的价格.

GPT 5.6 Sol 推荐codex渠道, 价格是人民币¥1.8(进)10.8(出)/一百万Token.只能说还行吧. 这个价格.
...
### [IKunCode](https://www.hvoy.ai/sites/apiikuncodecc)
...
GPT 5.6 Sol 价格是1(进)6(出)/一百万Token. 挺公道的价格.
