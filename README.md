...
Codex有月套餐, 50人民币一个月对应每日可用60$+昨日未用完的额度, 80人民币一个月对应每天120元+昨日未用完的额度.是目前看到最便宜的.(2026/3/25更新, 月套餐回来了)
...
也有Codex接口, 目前是GPT5.4 是人民币 0.1/0.6 一百万Token,  基本就是免费了, 挺厚道的.

用户注册送0.1元额度, 可以进行尝试网络.
