...
1. 在闲鱼上买一个 Codex team拼车的号, 大概8人民币保一个月
2. 然后把邮箱给他. 
...
### 九. [米醋AI](https://www.openclaudecode.cn/register?aff=rBFh)
...
### 六. [Terminal.Pub](https://terminal.pub/register?aff=rJW5)
...
### 九. [CCFly](https://ccfly.codes/?inviteCode=DAN39VOO)
这也是一个2026年新创建的站点. 
...
### 十. [TimiCC](https://timicc.com/register?ref=2CT3TAP7)
...
上新模型也比较快, 更多的是面向企业的服务, 稳定性还行, 还可以开发票.

Claude 接口方面, 他们的逆向出的东西不是很行.可以使用Claude code专用组, Opus4.6的价格是人民币¥6/30 一百万Token.
...
### 三. [大肘子](https://api.dzzi.ai/register?aff=AUIz)
...
### 四. [柏拉图AI](https://api.bltcy.ai/register)
