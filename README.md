...
看他们自己的Status网站, 自己维护的MAX号池稳定性100%, 而且试用看起来也是没有掺水.
...
譬如, 有1毛钱一次调用的opus4.6接口, 也有3毛的. 理论上3毛应该比1毛的质量要好点. 不过是掺水的.
...
价格方面, Claude Opus4.6是人民币¥5(进)25(出)/一百万Token, Sonnet4.6是人民币¥3(进)15(出)/一百万Token. 但是我试用了一会, 发现用低级别模型掺水挺严重的.不知道别的朋友试用效果如何. 
